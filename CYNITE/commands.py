...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/requestluciferdownload'),
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/Netflix_hindi_movies_4k')
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ʏᴛ ᴄʜᴀɴɴᴇʟ', url="https://youtube.com/@netflixhindimovies4k")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
