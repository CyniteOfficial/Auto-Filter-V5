...
BOT_TOKEN = environ.get('BOT_TOKEN', "5918067901:AAEMIifjJJ4YADpgWyb9Ff8xSQRqPnzIkIU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5149183428 6020596552').split()]
...
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/VisionBackup')
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'tarabox.in')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '3543feeb93755a3b9806883381d1443fb8944e32')
